...
export default function OurFounder(props) {
  ...
  const imgUrlList = [
    { src: "/img/discover-pg/mandi-2-lg.jpg", alt: "Photo of founder, Mandi" },
    { src: "/img/discover-pg/mandi-1-lg.jpg", alt: "Photo of founder, Mandi" },
    { src: "/img/discover-pg/mandi-3-lg.jpg", alt: "Photo of founder, Mandi" },
  ];
